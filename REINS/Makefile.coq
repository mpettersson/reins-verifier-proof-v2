...
# coq_makefile -I ../Model Int32.v PEFormat.v PETraversal.v ReinsVerifier.v ReinsVerifierDFA.v CompiledDFAs.v REINSjmp.v X86Lemmas.v ReinsDFACorrectness.v -o Makefile.coq 
#
